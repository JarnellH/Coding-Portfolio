 ...
 *  @Version 1.1
 * 
 *  The program below creates a linked list filled with elements of dog objects 
 * and it prints out the list as new dogs are being added to the list
 */
...
public class ListRunner {
    ...
    public static void main(String[] args) {
        ...
        // so this will print the list out in reverse order 
